...
**A Gemini 3 Pro + Nano Banana Pro‑powered AI tool for rapid 2D game pixel art/cultural design test‑fit.**
...
**一个基于 Gemini 3 Pro + Nano Banana Pro 用于快速进行2D游戏像素艺术/文化设计测试适配的 AI 工具**
...
- **GLSL着色器**：实时背景移除 + 边缘侵蚀消除白边
- **全自动工作流**：从文字输入到可玩动画角色，零手动切图

### 🛠️ 技术栈

- **引擎 & 脚本语言**：Godot + C# + GLSL
